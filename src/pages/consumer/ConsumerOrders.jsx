...
export default function ConsumerOrders() {
  ...
  useEffect(() => {
    ...
    let ordersQuery
    try {
      ordersQuery = query(collection(db, 'orders'), where('consumer_id', '==', user.id), orderBy('created_at', 'desc'))
    } catch (e) {
      ordersQuery = query(collection(db, 'orders'), where('consumer_id', '==', user.id))
    }
